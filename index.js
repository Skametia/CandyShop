...
function updateCandyQuantity(candyName, newQuantity) {
    axios
        .patch(`https://crudcrud.com/api/a7d2d44df3414d6689c215a78456af01/candy/${candyName}`, {
...
function getCandy() {
    axios
        .get("https://crudcrud.com/api/a7d2d44df3414d6689c215a78456af01/candy")
        .then((res) => {
            const candyArr = res.data;
            candyArr.forEach((candy) => {
                addCandy(candy.candyName, candy.description, candy.quantity, candy.price);
            });
            console.log(res);
        })
        .catch((err) => {
...
document.getElementById("main-form").addEventListener("submit", function (event) {
    ...
    axios
        .post("https://crudcrud.com/api/a7d2d44df3414d6689c215a78456af01/candy", {
            candyName,
            description,
            quantity,
            price,
